      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="GIONO 1.png" alt="First slide" />
            </div>
                      </div>
          <a class="carousel-control-prev" href="GIONO 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="GIONO 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <tbody>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Perumahan Dasana Indah Blok SR-02 No. 03 RT. 006 RW. 02, Desa Bojong Nangka, Kecamatan Kelapa Dua (d/h Legok), Kabupaten Tangerang, Provinsi Banten.																												
			</td>
            </tr>
			 <tr>
              <td>Basis Nilai</td>
			...
			<tr>
              ...
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B015'20.5%22S+106%C2%B035'28.1%22E/@-6.2556817,106.5885691,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.255687!4d106.591144?entry=ttu">
 -6.255687, 106.591144													
                  </a></td>
            </tr>
			<tr>
...
<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Perumahan Dasana Indah Blok SR-02 No. 14</td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
        ...
        <table class="table table-bordered">
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Perumahan Dasana Indah Blok SR-07		
	</td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
        ...
        <table class="table table-bordered">
         <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Perumahan Dasana Indah Blok SN-03 No. 05			
	</td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
